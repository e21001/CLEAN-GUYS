<?php
  ...
  function validate():array {
    ...
    // ファイル名から拡張子をチェックする
    if (!in_array(getExtension($_FILES['image']['name']), ['jpg','JPG', 'jpeg', 'JPEG', 'png', 'PNG', 'gif', 'GIF'])) {
  ...
  function generateDestinationPath():string {
    return 'profimage/' . date('Ymd-His-') . rand(10000, 99999) . '.' . getExtension($_FILES['image']['name']);
  }
